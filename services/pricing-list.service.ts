...
const SORT_FIELD_MAP: Record<string, string> = {
  ...
  sku: "product__sku",
  supplierName: "product__supplier__supplier_name",
  supplierCode: "product__supplier_code",
  state: "state_name",
  customerType: "customer_type__customer_type_name",
  category: "product__category__categoryName",
  segment: "product__segment__segment_name",
  packSize: "product__pack_size",
  unit: "product__unit",
  gstPct: "product__gst_rate__gstPercentage",
