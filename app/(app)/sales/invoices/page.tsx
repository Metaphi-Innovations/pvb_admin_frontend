...
function SortTh({ label, colKey, sortKey, sortDir, onSort }: {
  ...
  return (
    <th onClick={() => onSort(colKey)} className={cn("px-4 py-3 text-left text-xs font-semibold cursor-pointer select-none group whitespace-nowrap", active && "bg-brand-50/60")} title={label}>
