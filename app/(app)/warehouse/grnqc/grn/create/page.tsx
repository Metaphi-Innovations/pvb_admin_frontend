...
import { ArrowLeft, Plus, Trash2, Save, Send, Calendar, Check, AlertCircle } from "lucide-react";
      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex items-center justify-between border-b pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">Generate GRN</h1>
              <p className="text-xs text-muted-foreground">Register inward stock parameters and assign lot batches.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-border p-4 shadow-sm space-y-4">
          <h2 className="text-xs font-bold text-foreground uppercase tracking-wider border-b pb-2">
            Section 1: Receipt Header Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-medium text-muted-foreground">GRN Number</label>
              <Input value={grnNo} readOnly className="h-8 text-xs font-mono font-bold bg-muted/30" />
            </div>
