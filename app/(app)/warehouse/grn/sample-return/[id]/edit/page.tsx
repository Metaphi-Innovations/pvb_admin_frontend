  ...
  return (
    ...
    >
      <div className="max-w-[800px] mx-auto text-center py-12 space-y-4">
        ...
        <h1 className="text-base font-bold text-foreground">Edit Sample Return GRN</h1>
        <p className="text-xs text-muted-foreground">
          Editing finalized/received Sample Return Goods Receipt Notes is currently restricted.
        </p>
        <Button variant="outline" size="sm" onClick={() => router.push(`/warehouse/grn/sample-return/${params.id}`)}>
          Back to View
        </Button>
      </div>
    </RecordDetailPage>
