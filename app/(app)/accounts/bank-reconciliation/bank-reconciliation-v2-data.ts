...
/** Manual Bank Reconciliation client demo — 3 accounts only (no exception / fully-reconciled demos). */
const DEMO_ACCOUNTS: BankReconBankAccount[] = [
  {
    ...
    accountType: "Current",
    bookBalance: 1_512_822,
    statementBalance: 1_512_822,
  ...
  },
  {
    ...
    accountType: "Current",
    bookBalance: 1_571_750,
    statementBalance: 1_571_750,
    pendingTransactions: 5,
    lastReconciledDate: "2026-06-16",
    status: "Partially Reconciled",
    statementPeriodFrom: "2026-06-01",
    statementPeriodTo: "2026-06-30",
