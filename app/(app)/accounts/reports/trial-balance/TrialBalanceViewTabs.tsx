...
export function TrialBalanceViewTabs({
  value,
  onChange,
}: {
  value: TrialBalanceTab;
  onChange: (tab: TrialBalanceTab) => void;
}) {
  return (
...
export function trialBalanceViewLabel(tab: TrialBalanceTab): string {
