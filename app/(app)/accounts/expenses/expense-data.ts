    ...
    attachments: [
      {
        ...
        uploadedAt: demoDateAt(1),
        uploadedBy: "Amit Deshmukh",
      },
    ],
    approvalHistory: [
      { action: "created", by: "Amit Deshmukh", at: demoDateAt(2), remarks: "Submitted from mobile" },
      { action: "submitted", by: "Amit Deshmukh", at: demoDateAt(3), remarks: "Submitted for approval" },
    ],
    createdBy: "Amit Deshmukh",
    updatedBy: "Amit Deshmukh",
    createdAt: demoDateAt(4),
    updatedAt: demoDateAt(5),
  },
  {
    id: 2,
    expenseNumber: "EXP-2026-0002",
    expenseDate: demoDateAt(6),
    employeeId: 2,
    ...
    attachments: [],
    approvalHistory: [
      { action: "created", by: ACCOUNTS_CURRENT_USER, at: demoDateAt(7), remarks: "From TA/DA claim" },
      {
        action: "submitted",
        by: ACCOUNTS_CURRENT_USER,
        at: demoDateAt(8),
    ...
    createdBy: ACCOUNTS_CURRENT_USER,
    updatedBy: ACCOUNTS_CURRENT_USER,
    createdAt: demoDateAt(10),
    updatedAt: demoDateAt(11),
  },
  {
    id: 3,
    expenseNumber: "EXP-2026-0003",
    expenseDate: demoDateAt(12),
    employeeId: 1,
    ...
    attachments: [
      {
        ...
        fileSize: "89 KB",
        mimeType: "application/pdf",
        uploadedAt: demoDateAt(13),
        uploadedBy: ACCOUNTS_CURRENT_USER,
      },
    ],
    approvalHistory: [
      { action: "created", by: ACCOUNTS_CURRENT_USER, at: demoDateAt(14), remarks: "Expense created" },
      { action: "submitted", by: ACCOUNTS_CURRENT_USER, at: demoDateAt(15), remarks: "Submitted" },
      {
        action: "approved",
        by: ACCOUNTS_CURRENT_USER,
        at: demoDateAt(16),
    ...
    approvedBy: ACCOUNTS_CURRENT_USER,
    payment: {
      paymentDate: demoDateAt(18),
      paymentMode: "Bank Transfer",
      paymentReferenceNo: "UTR-88291002",
      paidAmount: 5040,
      paymentRemarks: "Paid via bank transfer",
      paidBy: ACCOUNTS_CURRENT_USER,
      paidAt: demoDateAt(19),
    },
    createdBy: ACCOUNTS_CURRENT_USER,
    updatedBy: ACCOUNTS_CURRENT_USER,
    createdAt: demoDateAt(20),
    updatedAt: demoDateAt(21),
  },
  {
    id: 4,
    expenseNumber: "EXP-2026-0004",
    expenseDate: demoDateAt(22),
    employeeId: 3,
    employeeName: "Amit Deshmukh",
    employeeCode: "EMP-0003",
    department: "Sales",
    ...
    attachments: [],
    approvalHistory: [
      { action: "created", by: ACCOUNTS_CURRENT_USER, at: demoDateAt(23), remarks: "Draft expense" },
    ],
    createdBy: ACCOUNTS_CURRENT_USER,
    updatedBy: ACCOUNTS_CURRENT_USER,
    createdAt: demoDateAt(24),
    updatedAt: demoDateAt(25),
  },
];

export function getExpensesSeedData(): AccountExpense[] {
  return structuredClone(SEED_EXPENSES);
}
