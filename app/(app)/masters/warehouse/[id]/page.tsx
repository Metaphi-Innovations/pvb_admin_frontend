        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-grow min-w-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground truncate">{warehouse.warehouseName}</h1>
                <p className="text-xs text-muted-foreground mt-0.5">
                  {warehouse.warehouseCode} • {warehouse.contactPerson} • {warehouse.mobileNumber}
                </p>
              </div>
