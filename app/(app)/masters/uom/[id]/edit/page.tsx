...
export default function EditUOMPage() {
  ...
  useEffect(() => {
    ...
    if (!found) { router.push("/masters/uom"); return; }
    setRecord(found);
    setAllUnits(records);
    setForm({
      ...
      conversionFactor: found.conversionFactor,
      status: found.status,
    });
  }, [id, router]);
  ...
  // Base units: exclude self and units derived from the current unit
    ...
    <AppLayout>
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-border px-6 py-3 flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-[11px] text-muted-foreground">Masters → Unit Master → {record.unitCode}</p>
        </div>
      ...
      <div className="flex gap-0">
        <div className="flex-1 p-6 space-y-6 max-w-[600px]">
          ...
          <div className="pb-3 border-b border-border pt-2">
            ...
            <p className="text-[11px] text-muted-foreground mt-0.5">
              Leave Base Unit empty if this is itself a base unit
            </p>
          </div>
        ...
        <div className="w-64 flex-shrink-0 border-l border-border bg-muted/20 p-5 space-y-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">Click Save Changes to update this unit</p>
          </div>
