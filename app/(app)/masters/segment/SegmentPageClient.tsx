...
type SortKey = "segmentCode" | "segmentName" | "description" | "status" | "createdBy" | "updatedBy";
...
export default function SegmentMasterPage() {
  ...
  const [sortKey, setSortKey] = useState<SortKey>("segmentCode");
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex-1 min-w-[220px] max-w-sm">
            ...
            <Input
              ...
              placeholder="Search segment code, name, description..."
          ...
          <Popover>
            ...
            <PopoverContent align="start" className="w-56 p-0 bg-white border shadow-lg border-border">
              <div className="px-3 py-2 border-b border-border">
                <p className="text-xs font-semibold text-foreground">Filter Segment</p>
              </div>
            ...
            <p className="text-[11px] text-muted-foreground">
              {filtered.length === 0 ? (
                ...
                <>
                  ...
                  <span className="font-medium text-foreground">{filtered.length}</span> segments
                </>
              )}
            </p>
            <div className="flex items-center gap-2">
