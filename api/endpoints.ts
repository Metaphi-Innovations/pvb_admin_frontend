export const API_ENDPOINTS = {
  ...
  MASTER: {
    ...
    PRICING: {
      ...
      BULK_CREATE: "/master/product-pricing/bulk-create",
      ...
      EXISTING_COMBINATIONS: "/master/product-pricing/existing-combinations",
  ...
  PROCUREMENT: {
    PURCHASE_ORDER: {
      ...
      SUPPLIER_DROPDOWN: "/procurement/purchase-order/supplier-dropdown",
      WAREHOUSE_DROPDOWN: "/procurement/purchase-order/warehouse-dropdown",
      DROPDOWN: "/procurement/purchase-order/dropdown",
  ...
  WAREHOUSE: {
    STOCK_OVERVIEW: {
      ...
      SALES_RETURN_EXPORT: "/warehouse/stock-overview/sales-return-stock/export",
